...
describe('KCard', () => {
  ...
  describe('content of the thumbnail placeholder slot', () => {
    ...
    it('is displayed when a thumbnail image is not provided', () => {
      const wrapper = makeWrapper({
        propsData: {
          to: { path: '/some-link' },
          title: 'sample title ',
    ...
    it('is displayed while a thumbnail image is loading (progressive loading experience on slow network)', () => {
      const wrapper = makeWrapper({
        propsData: {
          to: { path: '/some-link' },
          title: 'sample title ',
    ...
    it('is not displayed after a thumbnail image is successfully loaded', async () => {
      const wrapper = makeWrapper({
        propsData: {
          to: { path: '/some-link' },
          title: 'sample title ',
      ...
      wrapper.find('[data-test="thumbnail-img"]').vm.$emit('load');
