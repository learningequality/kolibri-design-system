...
describe('useMultiSelectCascade', () => {
  ...
  it('auto-promotes parent to selected when ALL children are selected (no autoSelectParent needed)', () => {
  ...
  it('without autoSelectParent, selecting a child does NOT immediately include its parent', () => {
  ...
  it('autoSelectChild: selecting a parent also selects all its descendants', () => {
  ...
  it('autoSelectChild: selecting a grandparent selects all descendants at every level', () => {
    normalizedOptions.value = [
      { value: 'root', label: 'Root', level: 1 },
      { value: 'a', label: 'A', level: 2 },
      { value: 'a1', label: 'A1', level: 3 },
