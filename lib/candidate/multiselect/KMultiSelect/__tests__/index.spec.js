...
describe('KMultiSelect — accessible name in single mode', () => {
  it('names the combobox by its label alone, without the selected value', () => {
    renderKMultiSelect({ multiple: false, value: 'banana', label: 'Fruit' });
    expect(getCombobox()).toHaveAccessibleName('Fruit');
  });
...
describe('KMultiSelect — single mode pre-fill (suppressFilter)', () => {
