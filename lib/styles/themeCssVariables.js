...
import { flattenThemeTree } from '../utils/themeCssVariableNaming';
...
/**
 * Returns the rule setting all theme CSS variables. `html:root` so that it outranks
 * the defaults in `themeDefaults.scss` however the two end up ordered in the document.
 */
