...
import KSnackbar from './KSnackbar/KSnackbar.vue';
...
export default function KThemePlugin(Vue) {
  ...
  Vue.prototype.$computedClass = computedClass; // Deprecated, see computedClass.js
  ...
  Vue.component('KSnackbar', KSnackbar);
}
