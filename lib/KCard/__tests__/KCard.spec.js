...
describe('KCard', () => {
  ...
  describe( 'it renders aboveTitle slot whether should occupy the area designated for it or not ', () => {
    it('preserves above-title space when preserveAboveTitle is true', () => {
      const wrapper = makeWrapper({
        propsData: { to: { path: '/some-link' }, title: 'sample title ', headingLevel: 4 , preserveAboveTitle: true },
          slots: {
            aboveTitle: 'above title',
         },
      });
    ...
    it('removes above-title space when preserveAboveTitle is false and slot is empty', () => {
      const wrapper =  makeWrapper({
        propsData: { to: { path: '/some-link' }, title: 'sample title ', headingLevel: 4 , preserveAboveTitle: false },
        slots: {
          aboveTitle: 'above title',
       },
      })
    ...
    it('adds correct margin to title when above-title is not preserved', async () => {
      const wrapper =  makeWrapper( {
        propsData: {
          to: { path: '/some-link' },title: 'sample title ', headingLevel: 4 , preserveAboveTitle: false },
        slots: {
        },
      })
