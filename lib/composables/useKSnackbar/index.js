 ...
 * @param {Boolean} [options.forceReuse=false] - If true, updates existing snackbartextwithout close
 * @param {Function} [options.onClose=null] - Callback fired when snackbar closes 
 */
function createSnackbar(options = {}) {
  const config = {
    ...
    onClose: options.onClose || null, // Added for Studio compatibility
  };
