...
describe('useKSnackbar composable', () => {
  ...
  describe('createSnackbar', () => {
    ...
    it('sets all options correctly', () => {
      ...
      expect(typeof snackbarOptions.value.actionCallback).toBe('function');
    ...
    it('wraps actionCallback to automatically close the snackbar when actionText is provided', () => {
      const actionCallback = jest.fn();
      createSnackbar({ text: 'Test', actionText: 'Undo', actionCallback, announce: true });
