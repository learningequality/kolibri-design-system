...
describe.visual('KImg', () => {
  ...
  const snapShotOptionTwo = { widths: [600], minHeight: 600 };
  ...
  it('Render KImgFitXYTest', async () => {
    ...
    await takeSnapshot('KImg - with - fitXY', snapShotOptionTwo);
  });

  it('Render KImgFitContain', async () => {
    await renderComponentForVisualTest('KImgFitContainTest');
    await takeSnapshot('KImg - with - fitContain', snapShotOptionTwo);
  });
  ...
  it('Render KImgWithBorder', async () => {
    await renderComponentForVisualTest('KImgWithBorder');
    await takeSnapshot('KImg - with - border', snapshotOptions);
  });

  it('Render KImgWithBackgroundColor', async () => {
    await renderComponentForVisualTest('KImgWithBackgroundColor');
