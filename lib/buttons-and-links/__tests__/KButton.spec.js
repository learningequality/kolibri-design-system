...
describe('KButton', () => {
  ...
  describe.visual('KButton Visual Tests', () => {
    it('renders correctly with default props', async () => {
      await renderComponent('KButton', { text: 'Test' });
      await takeSnapshot('KButton - Default');
    });
    it('renders correctly with default props - 2', async () => {
      await renderComponent('KButton', { text: 'Test 2' });
      await takeSnapshot('KButton - Default - 2');
    });
  });
});
