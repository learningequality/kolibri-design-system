...
describe('KRouterLink component', () => {
  ...
  describe('links', () => {
    ...
    it('should render a link with an icon before', async () => {
      ...
      expect(wrapper.classes()).toContain('link');
      expect(wrapper.find(`[data-testid="icon-before"]`).element).toBeTruthy();
      expect(wrapper.find(`[data-testid="icon-after"]`).element).toBeFalsy();
    });
    it('should render a link with an icon after', async () => {
      ...
      expect(wrapper.classes()).toContain('link');
      expect(wrapper.find(`[data-testid="icon-before"]`).element).toBeFalsy();
      expect(wrapper.find(`[data-testid="icon-after"]`).element).toBeTruthy();
    });
  });
