...
export default {
  ...
  computed: {
    ...
    durationBasedProgress() {
      let bye = this.timeSpent / (this.duration || this.defaultDuration)
      console.log('###', this.timeSpent, this.duration, this.defaultDuration, bye, this)
      return this.timeSpent / (this.duration || this.defaultDuration);
    },
    defaultItemPreset() {
