module.exports = function render() {
    with (this) {
        return _c('svg', {
            ...
            _c('path', { attrs: { 'd': 'M11.94 18.24c-.24.45-.94.28-.94-.24v-3.5H9.83a.5.5 0 0 1-.44-.74l.14-.26H7v7.17C7 21.4 7.6 22 8.33 22h7.33c.74 0 1.34-.6 1.34-1.33V13.5h-2.53l-2.53 4.74z' } }),
            _c('path', {
                attrs: {
                    'fill-opacity': '.3',
