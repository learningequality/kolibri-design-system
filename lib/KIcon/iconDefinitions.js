...
const KolibriIcons = {
  ...
  // Picture Login Icons
  beeColorful: {
    icon: require('./precompiled-icons/le/bee.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  beeStandard: {
  ...
  starColorful: {
    icon: require('./precompiled-icons/le/star.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  starStandard: {
  ...
  moonColorful: {
    icon: require('./precompiled-icons/le/moon.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  moonStandard: {
  ...
  treeColorful: {
    icon: require('./precompiled-icons/le/tree.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  treeStandard: {
  ...
  leafColorful: {
    icon: require('./precompiled-icons/le/leaf.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  leafStandard: {
  ...
  mouseColorful: {
    icon: require('./precompiled-icons/le/mouse.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  mouseStandard: {
  ...
  waterColorful: {
    icon: require('./precompiled-icons/le/water.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  waterStandard: {
  ...
  fishColorful: {
    icon: require('./precompiled-icons/le/fish.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  fishStandard: {
  ...
  dogColorful: {
    icon: require('./precompiled-icons/le/dog.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  dogStandard: {
  ...
  smileColorful: {
    icon: require('./precompiled-icons/le/smile.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  smileStandard: {
  ...
  flowerColorful: {
    icon: require('./precompiled-icons/le/flower.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  flowerStandard: {
  ...
  birdColorful: {
    icon: require('./precompiled-icons/le/bird.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  birdStandard: {
