...
const KolibriIcons = {
  ...
  resourceList: { icon: require('./precompiled-icons/material-icons/menu_book/baseline.vue').default },

  // Learning Activity icons
  allActivities: { icon: require('./precompiled-icons/le/all-solid.vue').default },
  createShaded: { icon: require('./precompiled-icons/le/create-shaded.vue').default },
  createSolid: { icon: require('./precompiled-icons/le/create-solid.vue').default },
  interactShaded: { icon: require('./precompiled-icons/le/interact-shaded.vue').default },
  interactSolid: { icon: require('./precompiled-icons/le/interact-solid.vue').default },
  listenShaded: { icon: require('./precompiled-icons/le/listen-shaded.vue').default },
  listenSolid: { icon: require('./precompiled-icons/le/listen-solid.vue').default },
  practiceShaded: { icon: require('./precompiled-icons/le/practice-shaded.vue').default },
  practiceSolid: { icon: require('./precompiled-icons/le/practice-solid.vue').default },
  readShaded: { icon: require('./precompiled-icons/le/read-shaded.vue').default },
  readSolid: { icon: require('./precompiled-icons/le/read-solid.vue').default },
  reflectShaded: { icon: require('./precompiled-icons/le/reflect-shaded.vue').default },
  reflectSolid: { icon: require('./precompiled-icons/le/reflect-solid.vue').default },
  watchShaded: { icon: require('./precompiled-icons/le/watch-shaded.vue').default },
  watchSolid: { icon: require('./precompiled-icons/le/watch-solid.vue').default },
};
