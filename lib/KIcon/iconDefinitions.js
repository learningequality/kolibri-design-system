...
const KolibriIcons = {
  ...
  openSidepanel: {
    icon: require('./precompiled-icons/le/openSidepanel.vue').default,
    rtlFlip: true,
  },
  closeSidepanel: {
    icon: require('./precompiled-icons/le/closeSidepanel.vue').default,
    rtlFlip: true,
  },
  admins: {
  ...
  bell: {
    icon: require('./precompiled-icons/le/bell.vue').default,
  },
  superAdmins: {
  ...
  course: {
    icon: require('./precompiled-icons/le/course.vue').default,
    rtlFlip: true,
  },
  ...
  communityLibrary: {
    icon: require('./precompiled-icons/le/communityLibrary.vue').default,
  },
  ...
  // Picture Login Icons
  beeColorful: {
    icon: require('./precompiled-icons/le/beeColorful.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  beeStandard: {
    icon: require('./precompiled-icons/le/beeStandard.vue').default,
    pictureLogin: true,
  },
  starColorful: {
    icon: require('./precompiled-icons/le/starColorful.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  starStandard: {
    icon: require('./precompiled-icons/le/starStandard.vue').default,
    pictureLogin: true,
  },
  moonColorful: {
    icon: require('./precompiled-icons/le/moonColorful.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  moonStandard: {
    icon: require('./precompiled-icons/le/moonStandard.vue').default,
    pictureLogin: true,
  },
  treeColorful: {
    icon: require('./precompiled-icons/le/treeColorful.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  treeStandard: {
    icon: require('./precompiled-icons/le/treeStandard.vue').default,
    pictureLogin: true,
  },
  leafColorful: {
    icon: require('./precompiled-icons/le/leafColorful.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  leafStandard: {
    icon: require('./precompiled-icons/le/leafStandard.vue').default,
    pictureLogin: true,
  },
  mouseColorful: {
    icon: require('./precompiled-icons/le/mouseColorful.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  mouseStandard: {
    icon: require('./precompiled-icons/le/mouseStandard.vue').default,
    pictureLogin: true,
  },
  waterColorful: {
    icon: require('./precompiled-icons/le/waterColorful.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  waterStandard: {
    icon: require('./precompiled-icons/le/waterStandard.vue').default,
    pictureLogin: true,
  },
  fishColorful: {
    icon: require('./precompiled-icons/le/fishColorful.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  fishStandard: {
    icon: require('./precompiled-icons/le/fishStandard.vue').default,
    pictureLogin: true,
  },
  dogColorful: {
    icon: require('./precompiled-icons/le/dogColorful.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  dogStandard: {
  ...
  smileColorful: {
    icon: require('./precompiled-icons/le/smileColorful.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  smileStandard: {
    icon: require('./precompiled-icons/le/smileStandard.vue').default,
    pictureLogin: true,
  },
  flowerColorful: {
    icon: require('./precompiled-icons/le/flowerColorful.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  flowerStandard: {
    icon: require('./precompiled-icons/le/flowerStandard.vue').default,
    pictureLogin: true,
  },
  birdColorful: {
    icon: require('./precompiled-icons/le/birdColorful.vue').default,
    pictureLogin: true,
    fixedColor: true,
  },
  birdStandard: {
    icon: require('./precompiled-icons/le/birdStandard.vue').default,
    pictureLogin: true,
  },
};
