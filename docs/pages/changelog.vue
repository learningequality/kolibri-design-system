  ...
  <DocsPageTemplate>
    ...
    <DocsPageSection title="Version 0.2" anchor="#0.2">
      ...
      <ul>
        ...
        <li>Added <code>a11y</code>, <code>alternativeRoute</code>, <code>disconnected</code>, <code>forwardRounded</code>, and <code>restart</code> icons - <DocsGithubLink pull="252" /></li>
      </ul>
