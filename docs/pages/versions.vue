  ...
  <DocsPageTemplate>
    ...
    <DocsPageSection title="Version 0.2" anchor="#0.2">
      ...
      <ul>
        ...
        <li>
          The filled icon with <code>copy</code> and <code>duplicate</code> aliases
          and the outlined <code>copyToClipboard</code> merged into one outlined icon
          with <code>copy</code> alias - <DocsGithubLink pull="251" />
        </li>
        <li>
          Removed <code>domain</code> alias from the icon that had previously had two
          <code>domain</code> and <code>facility</code> aliases - <DocsGithubLink pull="251" />
        </li> 
      </ul>
