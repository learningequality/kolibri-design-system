      ...
      >
        ...
        <template #javascript>
          <DocsShowCode language="javascript">
            ...
            'Grid111Example', components: { DocsKCard, KIcon, KTextTruncator }, };
          </DocsShowCode>
        </template>
      </DocsExample>
      ...
      >
        ...
        <template #javascript>
          <DocsShowCode language="javascript">
            ...
            <!-- eslint-disable-next-line -->
            import KTextTruncator from '../../../lib/KTextTruncator.vue'; export default { name:
            'Grid122Example', components: { DocsKCard, KIcon, KTextTruncator }, data() { return {
            loading: true, skeletonsConfig2: [ { breakpoints: [0,1,2,3,4,5,6,7], orientation:
            'vertical', thumbnailDisplay: 'large', height: '470px' }, { breakpoints: [2,3], height:
            '430px' }, { breakpoints: [4,5,6,7], height: '360px' }, ], }; }, mounted() {
      ...
      >
        ...
        <template #javascript>
          <DocsShowCode language="javascript">
            ...
            <!-- eslint-disable-next-line -->
            import KTextTruncator from '../../../lib/KTextTruncator.vue'; export default { name:
            'Grid123Example', components: { DocsKCard, KIcon, KTextTruncator }, data() { return {
            loading: true, skeletonsConfig3: [ { breakpoints: [0,1,2,3,4,5,6,7], orientation:
            'vertical', thumbnailDisplay: 'large', height: '470px' }, { breakpoints: [2,3], height:
            '430px' }, { breakpoints: [4,5,6,7], height: '390px' }, ], }; }, mounted() {
            setTimeout(() => { this.loading = false; }, 3000); }, };
          </DocsShowCode>
        </template>
      </DocsExample>
      ...
      >
        ...
        <template #javascript>
          <DocsShowCode language="javascript">
            ...
            loading: true, layoutOverride: [ { breakpoints: [0,1], columnGap: '20px', rowGap: '20px'
      ...
      >
        ...
        <template #javascript>
          <DocsShowCode language="javascript">
            ...
            <!-- eslint-disable-next-line -->
            import DocsKCard from '../../pages-components/DocsKCard.vue'; export default { name:
      ...
      >
        ...
        <template #javascript>
          <DocsShowCode language="javascript">
            ...
            import KTextTruncator from '../../../lib/KTextTruncator.vue';
            <!-- eslint-disable-next-line -->
            import KIcon from '../../../lib/KIcon.vue'; export default { name:
            'ResponsiveOrientationExample', components: { DocsKCard, KTextTruncator, KIcon },
      ...
      >
        ...
        <template #javascript>
          <DocsShowCode language="javascript">
            ...
            <!-- eslint-disable-next-line -->
            import KIcon from '../../../lib/KIcon.vue'; export default { name:
            'LoadingStateExample', components: { DocsKCard, KTextTruncator, KIcon }, setup() { const
            { windowBreakpoint } = useKResponsiveWindow(); return { windowBreakpoint }; }, data() {
            return { loading: true, debug: false, skeletonsConfig: [ { breakpoints:
